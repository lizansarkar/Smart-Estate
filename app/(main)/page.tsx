...
import { ArrowRight, Star, Users, Building2, Award, Shield, Clock, Search, MapPin } from 'lucide-react';
...
const features = [
  ...
  },
  {
    ...
    description: 'Find your perfect property with our intelligent AI-powered search recommendations.',
  },
  {
    icon: Clock,
    title: '24/7 Support',
  ...
  },
  {
    ...
    description: 'We only feature high-quality properties that meet our strict standards.',
  },
  {
    icon: Users,
    title: 'Expert Agents',
    description: 'Work with certified real estate professionals who know the market.',
  },
  {
    icon: Award,
    title: 'Award Winning',
    description: 'Recognized as the best real estate platform in Bangladesh for 3 consecutive years.',
  },
];
...
const testimonials = [
  {
    name: 'Sarah Ahmed',
    role: 'Home Buyer',
    content: 'Found my dream apartment in just 2 weeks! The AI recommendations were spot on.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'Excellent platform for investors. The analytics and market insights are invaluable.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'The best platform for agents. Easy to list properties and manage clients effectively.',
    rating: 5,
...
const blogPosts = [
  {
    ...
    excerpt: 'Discover the best family-friendly areas in Dhaka with excellent schools, parks, and community amenities.',
  ...
  },
  {
    ...
    excerpt: 'Learn about the latest market trends and investment opportunities in the Bangladeshi property market.',
  ...
  },
  {
    ...
    excerpt: 'Essential checklist for first-time home buyers to ensure you make the right investment decision.',
    image: 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=400&h=250&fit=crop',
    date: 'Jan 10, 2024',
    readTime: '6 min read',
  },
      ...
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white">
          ...
          <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto text-white/90">
            Discover apartments, houses, villas, and commercial properties with our AI-powered smart search and personalized recommendations.
          </p>

          <div className="max-w-4xl mx-auto bg-white/10 backdrop-blur-md rounded-2xl p-6 shadow-2xl">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium mb-2 text-white/90">Property Type</label>
              ...
              <div>
                <label className="block text-sm font-medium mb-2 text-white/90">Budget</label>
                <select className="w-full px-3 py-2 bg-white/20 border border-white/30 rounded-md text-white">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Discover our handpicked selection of premium properties across Bangladesh's most desirable locations.
            </p>
          </div>
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
            {[
              { name: 'Apartments', icon: Building2, count: '850+', href: '/properties?category=apartment' },
              { name: 'Houses', icon: Building2, count: '620+', href: '/properties?category=house' },
              { name: 'Villas', icon: Building2, count: '180+', href: '/properties?category=villa' },
              { name: 'Commercial', icon: Building2, count: '320+', href: '/properties?category=commercial' },
              { name: 'Land', icon: Building2, count: '150+', href: '/properties?category=land' },
            ].map((category) => (
              <Link
                key={category.name}
                href={category.href}
              ...
              >
                ...
                <p className="text-sm text-slate-600">{category.count} listings</p>
              </Link>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-background rounded-2xl p-6 shadow-md">
      ...
      <section className="py-16 bg-gradient-to-r from-primary to-primary/80 text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto opacity-90">
            Get personalized property recommendations powered by artificial intelligence. Chat with our AI assistant to find your perfect home.
          </p>
          <Button size="lg" variant="secondary" className="bg-secondary hover:bg-secondary/90 text-primary">
            Start AI Chat
            <ArrowRight className="h-5 w-5 ml-2" />
          </Button>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {blogPosts.map((post, index) => (
              <article key={index} className="bg-background rounded-2xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                <Image
                  src={post.image}
                  alt={post.title}
                  width={400}
